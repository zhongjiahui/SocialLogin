...
public class TitleLayout extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        titleTextColor = array.getColor(R.styleable.TitleLayout_titleTextColor, context.getColor(R.color.color_title_color));
        ...
        skipTextColor = array.getColor(R.styleable.TitleLayout_skipTextColor, context.getColor(R.color.color_main));
    ...
    private void addBackIcon(Context context) {
        ...
        imageView.setImageDrawable(context.getDrawable(R.drawable.ic_back));
    ...
    private void addSkipIcon(Context context) {
        ...
        skipImageView.setId(R.id.skip_image_view);
        skipImageView.setPadding((int) Util.dp2px(context, 8), 0, 0, 0);
        skipImageView.setImageDrawable(context.getDrawable(R.drawable.ic_skip));
    ...
    private void addSkipText(Context context) {
        ...
        TextView textView = new TextView(context);
        textView.setText(TextUtils.isEmpty(skipText) ? getResources().getString(R.string.skip) : skipText);
    ...
    private void addNetworkLayout(Context context) {
        ...
        imageView.setId(R.id.tip_image_view);
        ...
        TextView textView = new TextView(context);
        textView.setText(context.getString(R.string.network_error_tips));
        textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, titleTextSie);
        ...
        skipImageView.setPadding((int) Util.dp2px(context, 8), 0, 0, 0);
        skipImageView.setImageDrawable(context.getDrawable(R.drawable.ic_yellow));
        skipImageView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        addView(skipImageView);
