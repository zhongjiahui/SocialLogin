...
import com.zjh.social.web.helpers.OnBasicProfileListener;
import com.zjh.social.web.helpers.RequestHandler;
    ...
    private void showProgressDialog() {
        if (!WebAuthActivity.this.isFinishing()) {
            if (progressDialog == null) {
                ...
                builder.setView(R.layout.layout_web_auth_progress);
